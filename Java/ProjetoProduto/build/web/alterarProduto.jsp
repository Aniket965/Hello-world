            ...
            <form name="alterarproduto" id="alterarproduto" action="AlterarProduto"  method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type='text' readonly class="form-control" id="idProd" name="idProd" value='${produto.getIdProd()}'/>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="descProduto">Descrição</label>
                        <textarea class="form-control" id="descProduto" name="descProduto" >${produto.getDescProd()}</textarea>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input  type="text" name="marca" id="marca" class="form-control" value="${produto.getMarca()}"/>
                    </div>
                        ...
                        <select name="categoria" class="form-control" >
                            <c:forEach var="categoria" items="${categorias}">
                                ...
                                <option value="${categoria.idCategoria}"
                                        ${categoria.idCategoria == produto.getCategoria().getIdCategoria() 
                                          ? "selected" : "" }> 
