...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <!--</div>-->
            <form name="cadastrarcategoria" id="cadastrarcategoria" action="CadastrarCategoria"  method="POST">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" class="form-control" id="descCategoria" name="descCategoria" ></textarea>
                    </div>
